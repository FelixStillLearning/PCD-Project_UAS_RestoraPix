...
MIN_CONTOUR_AREA = 50           # Reduced minimum for smaller characters
MAX_CONTOUR_AREA_RATIO = 0.3    # Maximum 30% of image area
...
MIN_CONFIDENCE_THRESHOLD = 0.3  # Minimum confidence for acceptance
HIGH_CONFIDENCE_THRESHOLD = 0.8 # High confidence threshold
UNCERTAIN_THRESHOLD = 0.5       # Threshold for uncertain predictions
